...
parser.add_argument('--evaluation-episodes', type=int, default=150, metavar='N', help='Number of evaluation episodes to average over')
...
parser.add_argument('--op-scale-factor', type=float, default=1.025, metavar='w', help='Off-policy scale factor for tree correction')
...
parser.add_argument('--prunning-std-thresh', type=float, default=100, metavar='w', help='Best-to-second-best std threshold for tree prunning')
...
# Agent
dqn = Agent(args, env, full_env_name=full_env_name)
  ...
  for T in tqdm(range(args.T_max)):
    ...
    if T >= args.learn_start:
      ...
      if T % args.evaluation_interval == 0:
        ...
        log('T = ' + str(T) + ' / ' + str(args.T_max) + ' | Avg. reward: ' + str(results['avg_reward']) + ' | Avg. Q: ' + str(results['avg_Q']))
